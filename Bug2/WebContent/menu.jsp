        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <ul class="sub-menu collapse" id="products">
                    <li class="active"><a href="ViewProjectServlet">View Project</a></li>
                ...
                <ul class="sub-menu collapse" id="service">
                  <li><a href="http://localhost:8082/Bug/Bug.jsp">Raise Bug</a></li>
                  <li><a href="ViewSolutionServlet">View Bug</a></li>
