...
body
{
  background-image:url("bh-01.png");
}
 ...
 <div class="container">
        ...
        <li><a href="https://www.jquery-az.com/jquery-tips/">jQuery</a></li>-->
				...
				<!-- 	<li class="dropdown"><a
						...
						aria-haspopup="true" aria-expanded="false">TEAM<span
							class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a
								href="http://localhost:8082/Bug/team.jsp">ADD TEAM</a></li>
							
						</ul></li>
					<li class="dropdown"><a
						href="https://www.jquery-az.com/bootstrap-tips-tutorials/"
						class="dropdown-toggle" data-toggle="dropdown" role="button"
						aria-haspopup="true" aria-expanded="false">TEAM MEMBERS <span
							class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a
								href="http://localhost:8082/Bug/teammembers.jsp">ADD TEAM MEMBERS
									</a></li>
									<li><a
								href="ViewBugServlet">VIEW MEMBERS
									</a></li>
					...
					<li class="dropdown"><a
						...
						aria-haspopup="true" aria-expanded="false">PROJECT<span
							class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="http://localhost:8082/Bug/project.jsp">ADD PROJECT</a></li>

					
							<li><a href="ViewSolutionServlet">VIEW PROJECT</a></li>
